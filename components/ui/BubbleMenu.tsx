  ...
  return (
    <div className={`w-full ${useFixedPosition ? 'pointer-events-none' : ''}`} id="bubble-menu-root">
      ...
      <motion.div
        ...
        animate={{
          borderColor: isOpen ? 'rgba(212,0,0,0.45)' : 'rgba(255,255,255,0.12)',
          boxShadow: isOpen
            ? 'inset 0 1px 1px rgba(255,255,255,0.18), 0 18px 56px rgba(212,0,0,0.18), 0 16px 44px rgba(0,0,0,0.5)'
      ...
      >
        ...
        >
          <motion.span
            className="absolute inset-1 rounded-full bg-[#D40000]"
            initial={false}
            ...
            >
              <div className="mb-3 border-b border-white/[0.08] pb-3">
                ...
                >
                  ...
                  <span className="h-2 w-2 rounded-full bg-[#D40000] shadow-[0_0_18px_rgba(212,0,0,0.8)]" />
                </button>
              </div>
              ...
              <nav className="flex w-full flex-col gap-2" aria-label="Mobile Navigation">
                {items.map((item, index) => {
                  ...
                  const accentColor = item.hoverStyles?.bgColor || '#D40000';
